...
// var user = {
// //===================================================================================================
//   all: function(objColVals, condition, cb) {   // In this assignment when there will be request of "get" from client side 
//     orm.all("user", objColVals, condition, function(res) {
//       cb(res);
//     });
//   },
